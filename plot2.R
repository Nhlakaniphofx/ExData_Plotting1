#Function to plot line graph of datetime vs global active power in the household power consumption data
...
plot2 <- function()
{
  ...
  plot(data$DateTime, data$Global_active_power, type = "l",xlab = "",ylab = "Global Active Power (kilowatts)") #Plot line graph giving y a label of "Global Active Power (kilowatts)"
